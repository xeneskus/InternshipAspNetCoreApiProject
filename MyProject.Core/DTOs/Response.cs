...
{
    public class Response<T> where T : class //başarılı olana 200 başarısıza 400 mesela stasu code dönecek ve error verecek errordtodaki
    {
        ...
        //bes pricles ürünü update ettigimizde veya sildigimizde herhangi bir güncelleme veya bir şey yyaptıgımızda bu dataları geriye dönmeye gerek yok 200 koduyla boş data dönün ama ürün ekleme veya herhangi bir add metodunda dönmek gerekiyor sadece
